<!DOCTYPE html>
<!-- saved from url=(0036)https://ovatheme.com/meup/thank-you/ -->
<html lang="en-US">
    <?php
      ...
      $totcosto=$_SESSION["costo_totale"];
      $totcosto+=5;
      $spedizione=$_COOKIE['idspedizione'];  //== 'standard' or =='express'

        $idutente=$_SESSION['id'];
    $idevento=$_SESSION["idevento"];
    $codice_evento=$_SESSION["codice"];
    $nome_evento=$_SESSION["nomeE"];
    ...
    $fullname= $_SESSION['indirizzo_nome'];
       $email= $_SESSION['indirizzo_email'];
       $via =$_SESSION['indirizzo_via'];
       $cap= $_SESSION['indirizzo_cap'];
       $stato= $_SESSION['indirizzo_stato'];
       $citta= $_SESSION['indirizzo_citta'];
       $biglietti= $_SESSION['ticket'];
       $biglietti_vip= $_SESSION['ticketV'];
    ...
    $codice = '';
    for ($i = 0; $i < 8; $i++) {
        $codice .= $characters[rand(0, $charactersLength - 1)];}
    $codicefinale=strtoupper($codice);


    $query="insert into ordine VALUES (NULL, '$idutente','$idevento','$codicefinale', '$codice_evento', '$nome_evento', '$giorno','$orario','$biglietti', '$biglietti_vip', '$totcosto', '$via', '$fullname','$email', '$cap', '$stato', '$citta', '$spedizione') ";
    $dati=mysqli_query($connect, $query);
    //echo("error: " . mysqli_error($connect));

    $query="SELECT MAX(id) as massimo FROM ordine";
    $dati=mysqli_query($connect, $query);
    $valori=mysqli_fetch_array($dati);
    $ido=$valori["massimo"];

    $_SESSION['fine_ordine']=1;
...
<head>
    ...
    <link media="all" href="./styles/Checkout-confirmed/autoptimize_98c7faa396be5277d921de8b943c1aaa.css"
          rel="stylesheet">
    <link media="only screen and (max-width: 768px)"
          href="./styles/Checkout-confirmed/autoptimize_541e2ced151704f4ff1844c6de47ec02.css" rel="stylesheet">
    <title>Thank you – MeUp – Listing Marketplace Events WordPress Theme</title>
    ...
    <meta property="og:url" content="https://ovatheme.com/meup/thank-you/">
    ...
    <script src="./styles/Checkout-confirmed/wp-emoji-release.min.js" type="text/javascript" defer=""></script>
    <link rel="stylesheet" id="ova-google-fonts-css" href="./styles/Checkout-confirmed/css" type="text/css" media="all">
    <link rel="stylesheet" id="google-fonts-1-css" href="./styles/Checkout-confirmed/css(1)" type="text/css"
          media="all">
    ...
    <script type="text/javascript" src="./styles/Checkout-confirmed/jquery.min.js" id="jquery-core-js"></script>
    <script type="text/javascript" src="./styles/Checkout-confirmed/jquery-migrate.min.js"
            id="jquery-migrate-js"></script>
    <script type="text/javascript" src="./styles/Checkout-confirmed/v4-shims.min.js"
            id="font-awesome-4-shim-js"></script>
    <link rel="https://api.w.org/" href="https://ovatheme.com/meup/wp-json/">
    <link rel="alternate" type="application/json" href="https://ovatheme.com/meup/wp-json/wp/v2/pages/617">
    ...
    <link rel="canonical" href="https://ovatheme.com/meup/thank-you/">
    <link rel="shortlink" href="https://ovatheme.com/meup/?p=617">
    <link rel="alternate" type="application/json+oembed"
          href="https://ovatheme.com/meup/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fovatheme.com%2Fmeup%2Fthank-you%2F">
    <link rel="alternate" type="text/xml+oembed"
          href="https://ovatheme.com/meup/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fovatheme.com%2Fmeup%2Fthank-you%2F&amp;format=xml">
    <noscript>
...
<body class="page-template page-template-elementor_header_footer page page-id-617 theme-meup woocommerce-js elementor-default elementor-template-full-width elementor-kit-5045 elementor-page elementor-page-617 e--ua-blink e--ua-chrome e--ua-mac e--ua-webkit"
...
<div class="ova-wrapp">
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="wrap_ova_header bg_feature_img center "
                                                        ...
                                                        <div class="ova_header_el "><h1
                                                                class="second_font header_title"> Thank you</h1>
    ...
    <div data-elementor-type="wp-page" data-elementor-id="617" class="elementor elementor-617"
        ...
        <div class="elementor-inner">
            <div class="elementor-section-wrap">
                <section
                        class="elementor-section elementor-top-section elementor-element elementor-element-4b320887 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                        data-id="4b320887" data-element_type="section">
                    <div class="elementor-container elementor-column-gap-default">
                        <div class="elementor-row">
                            <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-206e2b06"
                                 data-id="206e2b06" data-element_type="column">
                                <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
                                        <div class="elementor-element elementor-element-376d1879 elementor-widget elementor-widget-text-editor"
                                             data-id="376d1879" data-element_type="widget"
                                             data-widget_type="text-editor.default">
                                            <div class="elementor-widget-container">
                                                <div class="elementor-text-editor elementor-clearfix"><p></p>
                                                    <p>Thanks for booking event. We sent pdf ticket file to your email.
                                                        You can view that file <?php echo" <a href='./backend/ticket.php?id=$ido' target='_blank'>here</a>"; ?>.<br>If you don’t receive
                                                        ticket, you can go to Manage account &gt;&gt; My Bookings&nbsp;
                                                        to download ticket.</p>
                                            ...
                                            <div class="elementor-element elementor-element-73e6158 elementor-widget elementor-widget-image"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-image"><a
                                                            href="https://ovatheme.com/meup/thank-you/#"> <img
                                                            src="./styles/Checkout-confirmed/Asset-9.svg"
                                            ...
                                            <div class="elementor-element elementor-element-077f622 elementor-widget elementor-widget-text-editor"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-text-editor elementor-clearfix"><p><span
                                                            style="color: #cccccc;">Lorem ipsum dolor sit amet, conse ctetuers adipiscing eli sed diam nonum nibhie…</span>
                                                    </p></div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="ova_social ova-framework-social-icons-wrapper">
                                                        <div class="content ui-tabs ui-corner-all ui-widget ui-widget-content">
                                                            <a class="ova-framework-icon ova-framework-social-icon ova-framework-social-icon-facebook"
                                                               href="https://ovatheme.com/meup/thank-you/#"
                                                               target="_blank"> <i class="fa fa-facebook" style=""></i>
                                                            </a> <a
                                                                class="ova-framework-icon ova-framework-social-icon ova-framework-social-icon-pinterest"
                                                                href="https://ovatheme.com/meup/thank-you/#"
                                                                target="_blank"> <i class="fa fa-pinterest"
                                                                                    style=""></i> </a> <a
                                                                class="ova-framework-icon ova-framework-social-icon ova-framework-social-icon-instagram"
                                                                href="https://ovatheme.com/meup/thank-you/#"
                                                                target="_blank"> <i class="fa fa-instagram"
                                                                                    style=""></i> </a> <a
                                                                class="ova-framework-icon ova-framework-social-icon ova-framework-social-icon-twitter"
                                                                href="https://ovatheme.com/meup/thank-you/#"
                                                                target="_blank"> <i class="fa fa-twitter" style=""></i>
                                                        </a></div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="elementor-widget-container">
                                                    <ul class="elementor-icon-list-items">
                                                        <li class="elementor-icon-list-item"><a
                                                                href="https://ovatheme.com/meup/thank-you/#"> <span
                                                                class="elementor-icon-list-text">About Us</span> </a>
                                                        </li>
                                                        <li class="elementor-icon-list-item"><a
                                                                href="https://ovatheme.com/meup/thank-you/#"> <span
                                                                class="elementor-icon-list-text">Submit Event</span>
                                                        </a></li>
                                                        <li class="elementor-icon-list-item"><a
                                                                href="https://ovatheme.com/meup/thank-you/#"> <span
                                                                class="elementor-icon-list-text">All Venues</span> </a>
                                                        </li>
                                                        <li class="elementor-icon-list-item"><a
                                                                href="https://ovatheme.com/meup/thank-you/#"> <span
                                                                class="elementor-icon-list-text">All Locations</span>
                                                        </a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="ova-contact">
                                                        ...
                                                        <div class="address"><span><a
                                                                href="https://ovatheme.com/meup/thank-you/#">San Francisco City Hall, San Francisco, CA</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="elementor-element elementor-element-644425e elementor-widget elementor-widget-ova_contact"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="ova-contact">
                                                        ...
                                                        <div class="address"><span><a
                                                                href="mailto:#">contact@domain.com</a></span></div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="elementor-column-wrap elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            ...
                                            <div class="elementor-element elementor-element-43a8fc4 elementor-widget elementor-widget-image"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-image"><img
                                                            src="./styles/Checkout-confirmed/apple-store-1-p5xxuvodl3i0xyrf15wbtg5ymuz4eoyk5w9tye8x6o.png"
                                            ...
                                            <div class="elementor-element elementor-element-059c2f8 elementor-widget elementor-widget-image"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-image"><img
                                                            src="./styles/Checkout-confirmed/google_play-1-p5xxuvodl3i0xyrf15wbtg5ymuz4eoyk5w9tye8x6o.png"
                                        ...
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-48367da elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container"><span
                                                        ...
                                                        href="https://ovatheme.com/meup/thank-you/#">Terms of use</a></span>
                                                </div>
                                            </div>
                                            <div class="elementor-element elementor-element-7ce4c95 elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container"><span
                                                        class="elementor-heading-title elementor-size-default"><a
                                                        href="https://ovatheme.com/meup/thank-you/#">|</a></span></div>
                                            </div>
                                            <div class="elementor-element elementor-element-edb059b elementor-widget__width-auto elementor-widget elementor-widget-heading"
                                                ...
                                                <div class="elementor-widget-container"><span
                                                        class="elementor-heading-title elementor-size-default"><a
                                                        href="https://ovatheme.com/meup/thank-you/#">Privacy policy</a></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<link rel="stylesheet" id="google-fonts-2-css" href="./styles/Checkout-confirmed/css(2)" type="text/css" media="all">
<script type="text/javascript" src="./styles/Checkout-confirmed/wp-polyfill.min.js" id="wp-polyfill-js"></script>
...
<script type="text/javascript" src="./styles/Checkout-confirmed/autoptimize_single_daca149c46601376ce5db68f3658323c.js"
        id="contact-form-7-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/image-map-pro.min.js"
        id="image-map-pro-dist-js-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/jquery.blockUI.min.js" id="jquery-blockui-js"></script>
...
<script type="text/javascript" src="./styles/Checkout-confirmed/add-to-cart.min.js" id="wc-add-to-cart-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/js.cookie.min.js" id="js-cookie-js"></script>
<script type="text/javascript" id="woocommerce-js-extra">var woocommerce_params = {
    "ajax_url": "\/meup\/wp-admin\/admin-ajax.php",
    "wc_ajax_url": "\/meup\/?wc-ajax=%%endpoint%%"
};</script>
<script type="text/javascript" src="./styles/Checkout-confirmed/woocommerce.min.js" id="woocommerce-js"></script>
...
<script type="text/javascript" src="./styles/Checkout-confirmed/cart-fragments.min.js"
        id="wc-cart-fragments-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/autoptimize_single_d12035cd792428533b661744dbb9ddc9.js"
        id="login-script-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/core.min.js" id="jquery-ui-core-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/datepicker.min.js"
...
<script type="text/javascript" src="./styles/Checkout-confirmed/autoptimize_single_4b769cafd6b65a845a9f7f52ba3c6d7a.js"
        id="datepicker-lang-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/tabs.min.js" id="jquery-ui-tabs-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/menu.min.js" id="jquery-ui-menu-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/dom-ready.min.js" id="wp-dom-ready-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/hooks.min.js" id="wp-hooks-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/i18n.min.js" id="wp-i18n-js"></script>
<script type="text/javascript"
...
<script type="text/javascript" src="./styles/Checkout-confirmed/a11y.min.js" id="wp-a11y-js"></script>
...
<script type="text/javascript" src="./styles/Checkout-confirmed/autocomplete.min.js"
        id="jquery-ui-autocomplete-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/mouse.min.js" id="jquery-ui-mouse-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/slider.min.js" id="jquery-ui-slider-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/jquery.timepicker.min.js"
        id="jquery-timepicker-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/select2.full.min.js" id="select2-js"></script>
<script type="text/javascript"
        id="el_frontend-js-extra">var ajax_object = {"ajax_url": "https:\/\/ovatheme.com\/meup\/wp-admin\/admin-ajax.php"};</script>
<script type="text/javascript" src="./styles/Checkout-confirmed/script.min.js" id="el_frontend-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/autoptimize_single_bde3ef153ef9af42e6d47799763a7640.js"
        id="script-eventlist-elementor-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/bootstrap.bundle.min.js" id="bootstrap-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/autoptimize_single_f8f19ecc1b41a55f504fd1010e328e15.js"
        id="meup-script-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/autoptimize_single_85c4beefac54b2cedfb6d98d753bc926.js"
        id="prettyphoto-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/wp-embed.min.js" id="wp-embed-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/autoptimize_single_0965b41abff22e79d7548d3890ead528.js"
        id="script-elementor-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/webpack.runtime.min.js"
        id="elementor-webpack-runtime-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/frontend-modules.min.js"
        id="elementor-frontend-modules-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/waypoints.min.js" id="elementor-waypoints-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/swiper.min.js" id="swiper-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/share-link.min.js" id="share-link-js"></script>
<script type="text/javascript" src="./styles/Checkout-confirmed/dialog.min.js" id="elementor-dialog-js"></script>
<script type="text/javascript" id="elementor-frontend-js-before">var elementorFrontendConfig = {
    ...
    "post": {
        "id": 617,
        "title": "Thank%20you%20%E2%80%93%20MeUp%20%E2%80%93%20Listing%20Marketplace%20Events%20WordPress%20Theme",
        "excerpt": "",
        "featuredImage": false
    }
};</script>
<script type="text/javascript" src="./styles/Checkout-confirmed/frontend.min.js" id="elementor-frontend-js"></script>
<span id="elementor-device-mode" class="elementor-screen-only"></span>
<script type="text/javascript" src="./styles/Checkout-confirmed/preloaded-modules.min.js"
...
<!-- Cached page generated by WP-Super-Cache on 2021-07-14 15:53:13 -->
...
<a id="scrollUp" href="https://ovatheme.com/meup/thank-you/#top"
