<!DOCTYPE html>
<!-- saved from url=(0056)https://ovatheme.com/meup/member-account/?vendor=profile -->
<html lang="en-US">
<?php
...
<head>
    ...
    <link href="./styles/UserAccount/autoptimize_14800de29b58526341fd82eab9388722.css" media="all"
          rel="stylesheet">
    <link href="./styles/UserAccount/autoptimize_541e2ced151704f4ff1844c6de47ec02.css"
    ...
    <script defer="" src="./styles/UserAccount/wp-emoji-release.min.js" type="text/javascript"></script>
    <link href="./styles/UserAccount/dashicons.min.css" id="dashicons-css" media="all" rel="stylesheet"
          type="text/css">
    <link href="./styles/UserAccount/css" id="ova-google-fonts-css" media="all" rel="stylesheet"
          type="text/css">
    <link href="./styles/UserAccount/css(1)" id="google-fonts-1-css" media="all" rel="stylesheet"
          type="text/css">
    ...
    <script id="jquery-core-js" src="./styles/UserAccount/jquery.min.js" type="text/javascript"></script>
    <script id="jquery-migrate-js" src="./styles/UserAccount/jquery-migrate.min.js"
            type="text/javascript"></script>
    <script id="font-awesome-4-shim-js" src="./styles/UserAccount/v4-shims.min.js"
            type="text/javascript"></script>
    ...
    <script id="utils-js" src="./styles/UserAccount/utils.min.js" type="text/javascript"></script>
    <script id="moxiejs-js" src="./styles/UserAccount/moxie.min.js" type="text/javascript"></script>
    <script id="plupload-js" src="./styles/UserAccount/plupload.min.js" type="text/javascript"></script>
    <!--[if lt IE 8]>
    ...
    <script charset="UTF-8" src="./styles/UserAccount/common.js" type="text/javascript"></script>
    <script charset="UTF-8" src="./styles/UserAccount/util.js" type="text/javascript"></script>
</head>
        ...
        <div class="elementor-inner">
            <div class="elementor-section-wrap">
                <section
                    ...
                    $result = select_ordine_utente($connection, $id);
                    ...
                    for ( $day = 1; $day <= $day_count; $day++, $str++) {
                        ...
                        if ($today == $date) {
                            ...
                            foreach ($items as $values) {
                                if($values['data'] == $date){
                                    $link = "./Details.php?id=" . $values['id_evento'];
                                    $week .= '<br><br><a style="color:#e86c60;" href=' . $link . '>'. $values['nome_evento'] . '</a>'
                                        . '<br><p style="color:#e86c60;">' . $ora . '</p>';                                }
                            }

                        } else {
                            $week .= '<td style="max-width: 8px;">' . $day;
                            foreach ($items as $values) {
                                if($values['data'] == $date){
                                    $link = "./Details.php?id=" . $values['id_evento'];
                                    $ora = $values['orario'];
                                                    ...
                                                    <div class="vendor_wrap">
                                                        <div class="vendor_sidebar">
                                                            <div class="vendor_user_profile">
                                                                <div class="wrap_image" style="border:1px solid gray; padding: 9% 6.5%; font-size: 28px; position: center;border-color: #e86c60"><?php echo '<b>' . strtoupper($_SESSION['nome'][0]) . "</b><b> " . strtoupper($_SESSION['cognome'][0]) . '</b>'; ?></div>
                                                        ...
                                                        <div class="contents"><h3 class="vendor_heading"> My
                                                            Profile</h3>
                                                            <div class="vendor_profile">
                                                                <div class="content ui-tabs ui-corner-all ui-widget ui-widget-content">
                                                                    <ul class="vendor_tab ui-tabs-nav ui-corner-all ui-helper-reset ui-helper-clearfix ui-widget-header"
                                                                        role="tablist">
                                                                        <li aria-controls="author_calendar" aria-expanded="false"
                                                                            aria-labelledby="ui-id-2"
                                                                            aria-selected="false"
                                                                            class="ui-tabs-tab ui-corner-top ui-state-default ui-tab ui-state-active"
                                                                            role="tab" tabindex="-1">
                                                                            <a class="ui-tabs-anchor"
                                                                               href="https://ovatheme.com/meup/member-account/?vendor=profile#author_calendar" id="ui-id-2"
                                                                               role="presentation" tabindex="-1">Calendar</a>
                                                                        </li>
                                                                        <li aria-controls="author_profile" aria-expanded="true"
                                                                            aria-labelledby="ui-id-1"
                                                                            aria-selected="true"
                                                                            class="ui-tabs-tab ui-corner-top ui-state-default ui-tab"
                                                                            role="tab" tabindex="0"><a
                                                                                class="active ui-tabs-anchor"
                                                                                href="https://ovatheme.com/meup/member-account/?vendor=profile#author_profile"
                                                                                id="ui-id-1" role="presentation"
                                                                                tabindex="-1">Profile</a></li>
                                                                        <li aria-controls="author_password" aria-expanded="false"
                                                                            aria-labelledby="ui-id-2"
                                                                            aria-selected="false"
                                                                            class="ui-tabs-tab ui-corner-top ui-state-default ui-tab"
                                                                            role="tab" tabindex="-1">
                                                                            <a class="ui-tabs-anchor"
                                                                               href="https://ovatheme.com/meup/member-account/?vendor=profile#author_password" id="ui-id-2"
                                                                               role="presentation" tabindex="-1">Password</a>
                                                                        </li>
                                                                    </ul>
                                                                    <?php

                                                                    $result=select_utente_dettagli($connection, $id);
                                                                    ...
                                                                    <div aria-hidden="false" aria-labelledby="ui-id-1"
                                                                         ...
                                                                         id="author_profile"
                                                                         role="tabpanel">
                                                                        <form autocapitalize="none" action="<?php echo $_SERVER['PHP_SELF'] ?>"
                                                                              autocomplete="nope"
                                                                              autocorrect="off" enctype="multipart/form-data"
                                                                              id="el_save_profile" method="post">

                                                                            <div class="vendor_field"><label
                                                                                    class="control-label"
                                                                                    for="display_username">Username</label>
																				<input id="display_username"
																					   name="username"
																					   placeholder="William Smith" required=""
																					   type="text"
																					   value='<?php echo"$username"; ?>'></div>
                                                                            <div class="vendor_field"><label
                                                                                    class="control-label"
                                                                                    for="display_name">Name</label>
                                                                                <input id="display_name"
                                                                                       name="nome"
                                                                                       placeholder="William Smith" required=""
                                                                                       type="text"
                                                                                       value='<?php echo"$nome"; ?>'></div>
																			<div class="vendor_field"><label
																					class="control-label"
																					for="display_surname">Surname</label>
																				<input id="display_surname"
																					   name="cognome"
																					   placeholder="William Smith" required=""
																					   type="text"
																					   value='<?php echo"$cognome"; ?>'></div>
                                                                            <div class="vendor_field"><label
                                                                                    class="control-label"
                                                                            ...
                                                                            <div class="vendor_field"><label
                                                                                ...
                                                                                <input id="user_phone" name="telefono"
                                                                                       placeholder="(+123) 456 7890" type="text"
                                                                                       value='<?php echo"$telefono"; ?>'>
                                                                            </div>
                                                                            <div class="vendor_field"><label
                                                                                    class="control-label"
                                                                                    for="user_address">Address</label>
                                                                                <input id="user_address" name="indirizzo"
                                                                                       placeholder= type="text"
                                                                                       value='<?php echo" $indirizzo"; ?>'></div>
                                                                            <!--<div class="vendor_field"><label
                                                                                    class="control-label"
                                                                                    for="description">Description</label><textarea
                                                                                    class="description form-control input-md " id="description"
                                                                                    name="description" placeholder="Insert Description"
                                                                                    type="text"
                                                                                    value="test">test</textarea>
                                                                            </div>-->
                                                                            <div class="vendor_field"><input
                                                                                    class="button el_submit_btn"
                                                                                    name="personal_detail"
                                                                                    type="submit"
                                                                                    value="Update Profile"></div>
                                                                            <input id="el_update_profile_nonce"
                                                                                   name="personal_detail"
                                                                                   type="hidden"
                                                                                   value="de3a9ab1bc"><input
                                                                    ...
                                                                    <div aria-hidden="true" aria-labelledby="ui-id-2"
                                                                         class="ui-tabs-panel ui-corner-bottom ui-widget-content"
                                                                         id="author_password"
                                                                         role="tabpanel" style="display: none;">
                                                                        <form autocapitalize="none"
                                                                              autocomplete="nope"
                                                                              autocorrect="off" enctype=<?php echo $_SERVER['PHP_SELF'] ?>"
                                                                              id="el_save_password" method="post">
                                                                            <div class="wrap_old_password vendor_field">
                                                                                ...
                                                                                <input id="old_password" name="op"
                                                                                       placeholder="Old Password"
                                                                                       required=""
                                                                                       type="password"
                                                                                       value="">
                                                                                <div class="check_old_pass"
                                                                            ...
                                                                            <input class="el_submit_btn"
                                                                                   name="change_password"
                                                                                   type="submit"
                                                                                   value="Update Password"> <input
                                                                                id="el_update_password_nonce"
                                                                                name="el_update_password_nonce"
                                                                                type="hidden"
                                                                                value="8fd6e9bcc8"><input name="_wp_http_referer"
                                                                                                          type="hidden"
                                                                                                          value="/meup/member-account/?vendor=profile">
                                                                        </form>
                                                                    </div>
                                                                    ...
                                                                    <div aria-hidden="true" aria-labelledby="ui-id-2"
                                                                         ...
                                                                         id="author_calendar"
                                                                         role="tabpanel" style="display: none;">
                                                                            <center><h2>Personal Calendar</h2></center>
                    ...
                    <section
                        ...
                        <div class="elementor-container elementor-column-gap-default">
                            <div class="elementor-row">
                                ...
                                <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-bf89ae0"
                                     data-element_type="column" data-id="bf89ae0">
                                    <div class="elementor-column-wrap elementor-element-populated">
                                    </div>
                                </div>
                            </div>
...
<script id="wp-polyfill-js" src="./styles/UserAccount/wp-polyfill.min.js" type="text/javascript"></script>
...
<script id="contact-form-7-js"
        src="./styles/UserAccount/autoptimize_single_daca149c46601376ce5db68f3658323c.js"
        type="text/javascript"></script>
<script id="image-map-pro-dist-js-js" src="./styles/UserAccount/image-map-pro.min.js"
        type="text/javascript"></script>
<script id="jquery-blockui-js" src="./styles/UserAccount/jquery.blockUI.min.js"
        type="text/javascript"></script>
...
<script id="wc-add-to-cart-js" src="./styles/UserAccount/add-to-cart.min.js" type="text/javascript"></script>
<script id="js-cookie-js" src="./styles/UserAccount/js.cookie.min.js" type="text/javascript"></script>
<script id="woocommerce-js-extra" type="text/javascript">var woocommerce_params = {
    "ajax_url": "\/meup\/wp-admin\/admin-ajax.php",
    "wc_ajax_url": "\/meup\/?wc-ajax=%%endpoint%%"
};</script>
<script id="woocommerce-js" src="./styles/UserAccount/woocommerce.min.js" type="text/javascript"></script>
...
<script id="wc-cart-fragments-js" src="./styles/UserAccount/cart-fragments.min.js"
        type="text/javascript"></script>
<script id="login-script-js"
        src="./styles/UserAccount/autoptimize_single_d12035cd792428533b661744dbb9ddc9.js"
        type="text/javascript"></script>
<script id="underscore-js" src="./styles/UserAccount/underscore.min.js" type="text/javascript"></script>
<script id="shortcode-js" src="./styles/UserAccount/shortcode.min.js" type="text/javascript"></script>
<script id="backbone-js" src="./styles/UserAccount/backbone.min.js" type="text/javascript"></script>
<script id="wp-util-js-extra"
        type="text/javascript">var _wpUtilSettings = {"ajax": {"url": "\/meup\/wp-admin\/admin-ajax.php"}};</script>
<script id="wp-util-js" src="./styles/UserAccount/wp-util.min.js" type="text/javascript"></script>
<script id="wp-backbone-js" src="./styles/UserAccount/wp-backbone.min.js" type="text/javascript"></script>
...
<script id="media-models-js" src="./styles/UserAccount/media-models.min.js" type="text/javascript"></script>
...
<script id="wp-plupload-js" src="./styles/UserAccount/wp-plupload.min.js" type="text/javascript"></script>
<script id="jquery-ui-core-js" src="./styles/UserAccount/core.min.js" type="text/javascript"></script>
<script id="jquery-ui-mouse-js" src="./styles/UserAccount/mouse.min.js" type="text/javascript"></script>
<script id="jquery-ui-sortable-js" src="./styles/UserAccount/sortable.min.js" type="text/javascript"></script>
...
<script id="mediaelement-core-js" src="./styles/UserAccount/mediaelement-and-player.min.js"
        type="text/javascript"></script>
<script id="mediaelement-migrate-js" src="./styles/UserAccount/mediaelement-migrate.min.js"
        type="text/javascript"></script>
...
<script id="wp-mediaelement-js" src="./styles/UserAccount/wp-mediaelement.min.js"
        type="text/javascript"></script>
...
<script id="wp-api-request-js" src="./styles/UserAccount/api-request.min.js" type="text/javascript"></script>
<script id="wp-dom-ready-js" src="./styles/UserAccount/dom-ready.min.js" type="text/javascript"></script>
<script id="wp-hooks-js" src="./styles/UserAccount/hooks.min.js" type="text/javascript"></script>
<script id="wp-i18n-js" src="./styles/UserAccount/i18n.min.js" type="text/javascript"></script>
...
<script id="wp-a11y-js" src="./styles/UserAccount/a11y.min.js" type="text/javascript"></script>
<script id="clipboard-js" src="./styles/UserAccount/clipboard.min.js" type="text/javascript"></script>
...
<script id="media-views-js" src="./styles/UserAccount/media-views.min.js" type="text/javascript"></script>
<script id="media-editor-js-translations" type="text/javascript">(function (domain, translations) {
    var localeData = translations.locale_data[domain] || translations.locale_data.messages;
    localeData[""].domain = domain;
    wp.i18n.setLocaleData(localeData, domain);
})("default", {"locale_data": {"messages": {"": {}}}});</script>
<script id="media-editor-js" src="./styles/UserAccount/media-editor.min.js" type="text/javascript"></script>
<script id="media-audiovideo-js" src="./styles/UserAccount/media-audiovideo.min.js"
        type="text/javascript"></script>
<script id="jquery-ui-draggable-js" src="./styles/UserAccount/draggable.min.js"
        type="text/javascript"></script>
<script id="jquery-ui-slider-js" src="./styles/UserAccount/slider.min.js" type="text/javascript"></script>
<script id="jquery-touch-punch-js"
        src="./styles/UserAccount/autoptimize_single_4cc86d1003c45134d6838f13e3885db1.js"
        type="text/javascript"></script>
<script id="iris-js" src="./styles/UserAccount/iris.min.js" type="text/javascript"></script>
...
<script id="wp-color-picker-js" src="./styles/UserAccount/color-picker.min.js" type="text/javascript"></script>
<script id="google-js" src="./styles/UserAccount/js" type="text/javascript"></script>
<script id="google-marker-js"
        src="./styles/UserAccount/autoptimize_single_b3288ceb3ec27947e85dbbc430025f23.js"
        type="text/javascript"></script>
<script id="tooltip-js" src="./styles/UserAccount/tooltip.min.js" type="text/javascript"></script>
<script id="el_validate-js" src="./styles/UserAccount/jquery.validate.min.js" type="text/javascript"></script>
<script id="el_flot-js"
        src="./styles/UserAccount/autoptimize_single_89bc8ea971e99653717fa69a73d70bb4.js"
        type="text/javascript"></script>
<script id="el_flot_pie-js"
        src="./styles/UserAccount/autoptimize_single_62dbbef98865feaa20a7f936c56ab931.js"
        type="text/javascript"></script>
<script id="el_flot_resize-js"
        src="./styles/UserAccount/autoptimize_single_826b0d2739932ac103bf420dbadd048e.js"
        type="text/javascript"></script>
<script id="el_flot_stack-js"
        src="./styles/UserAccount/autoptimize_single_76945205e6094cc16871aef9b27606d7.js"
        type="text/javascript"></script>
<script id="el_flot_time-js"
        src="./styles/UserAccount/autoptimize_single_6a49d955cbc76f5c2fecce8a185f6291.js"
        type="text/javascript"></script>
<script id="jquery-ui-datepicker-js" src="./styles/UserAccount/datepicker.min.js"
        type="text/javascript"></script>
...
<script id="datepicker-lang-js"
        src="./styles/UserAccount/autoptimize_single_4b769cafd6b65a845a9f7f52ba3c6d7a.js"
        type="text/javascript"></script>
<script id="jquery-ui-tabs-js" src="./styles/UserAccount/tabs.min.js" type="text/javascript"></script>
<script id="jquery-ui-menu-js" src="./styles/UserAccount/menu.min.js" type="text/javascript"></script>
...
<script id="jquery-ui-autocomplete-js" src="./styles/UserAccount/autocomplete.min.js"
        type="text/javascript"></script>
<script id="jquery-timepicker-js" src="./styles/UserAccount/jquery.timepicker.min.js"
        type="text/javascript"></script>
<script id="el_script_admin-js" src="./styles/UserAccount/admin.min.js" type="text/javascript"></script>
<script id="select2-js" src="./styles/UserAccount/select2.full.min.js" type="text/javascript"></script>
...
<script id="el_frontend-js" src="./styles/UserAccount/script.min.js" type="text/javascript"></script>
<script id="script-eventlist-elementor-js"
        src="./styles/UserAccount/autoptimize_single_bde3ef153ef9af42e6d47799763a7640.js"
        type="text/javascript"></script>
<script id="bootstrap-js" src="./styles/UserAccount/bootstrap.bundle.min.js" type="text/javascript"></script>
<script id="meup-script-js"
        src="./styles/UserAccount/autoptimize_single_f8f19ecc1b41a55f504fd1010e328e15.js"
        type="text/javascript"></script>
<script id="prettyphoto-js"
        src="./styles/UserAccount/autoptimize_single_85c4beefac54b2cedfb6d98d753bc926.js"
        type="text/javascript"></script>
<script id="wp-embed-js" src="./styles/UserAccount/wp-embed.min.js" type="text/javascript"></script>
<script id="script-elementor-js"
        src="./styles/UserAccount/autoptimize_single_0965b41abff22e79d7548d3890ead528.js"
        type="text/javascript"></script>
<script id="elementor-webpack-runtime-js" src="./styles/UserAccount/webpack.runtime.min.js"
        type="text/javascript"></script>
<script id="elementor-frontend-modules-js" src="./styles/UserAccount/frontend-modules.min.js"
        type="text/javascript"></script>
<script id="elementor-waypoints-js" src="./styles/UserAccount/waypoints.min.js"
        type="text/javascript"></script>
<script id="swiper-js" src="./styles/UserAccount/swiper.min.js" type="text/javascript"></script>
<script id="share-link-js" src="./styles/UserAccount/share-link.min.js" type="text/javascript"></script>
<script id="elementor-dialog-js" src="./styles/UserAccount/dialog.min.js" type="text/javascript"></script>
...
<script id="elementor-frontend-js" src="./styles/UserAccount/frontend.min.js" type="text/javascript"></script>
<span class="elementor-screen-only" id="elementor-device-mode"></span>
<script id="preloaded-modules-js" src="./styles/UserAccount/preloaded-modules.min.js"
        type="text/javascript"></script>
...
if(isset($_POST["personal_detail"])){
    ...
    if(isset($_FILES["fotoP"]) && !empty( $_FILES["fotoP"]["name"])) {
            ...
            && ($_FILES["fotoP"]["size"] < 40000000))
        {
            move_uploaded_file($_FILES["fotoP"]["tmp_name"],
                "./backend/upload/" . $_FILES["fotoP"]["name"]);
    ...
    update_info($connection, $id, $nome, $cognome,$username, $telefono, $indirizzo, $foto_p);
...
if(isset($_POST["change_password"])){
    ...
    $vecchiaPSW=$_POST["op"];
    $nuovaPSW=$_POST["np"];
    //$rptnuovaPSW=$_POST["rnp"];

    $ris=update_password($connection,$id,$vecchiaPSW,$nuovaPSW);
header("location: ./UserAccount.php");}
...
<a href="https://ovatheme.com/meup/member-account/?vendor=profile#top" id="scrollUp"
