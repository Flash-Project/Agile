<!DOCTYPE html>
<!-- saved from url=(0042)https://ovatheme.com/meup/member-register/ -->
<html lang="en-US">
<?php
...
<head>
    ...
    <link media="all" href="./styles/Register/autoptimize_cd8d7c697c49f8e28e33936dcbd09c07.css" rel="stylesheet">
    <link media="only screen and (max-width: 768px)"
          href="./styles/Register/autoptimize_541e2ced151704f4ff1844c6de47ec02.css" rel="stylesheet">
    <title>Register – MeUp</title>
    <script src="./styles/Register/wp-emoji-release.min.js" type="text/javascript" defer=""></script>
    <link rel="stylesheet" id="ova-google-fonts-css" href="./styles/Register/css" type="text/css" media="all">
    <link rel="stylesheet" id="google-fonts-1-css" href="./styles/Register/css(1)" type="text/css" media="all">

    <script type="text/javascript" src="./styles/Register/jquery.min.js" id="jquery-core-js"></script>
    <script type="text/javascript" src="./styles/Register/jquery-migrate.min.js" id="jquery-migrate-js"></script>
    <script type="text/javascript" src="./styles/Register/v4-shims.min.js" id="font-awesome-4-shim-js"></script>


</head>
<body class="page-template page-template-elementor_header_footer page page-id-334 theme-meup woocommerce-js elementor-default elementor-template-full-width elementor-kit-5045 elementor-page elementor-page-334 e--ua-blink e--ua-chrome e--ua-mac e--ua-webkit"
...
<div class="ova-wrapp">
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="wrap_ova_header bg_feature_img center "
                                                        ...
                                                        <div class="ova_header_el "><h1
                                                                class="second_font header_title"> Register</h1>
    ...
    <div data-elementor-type="wp-post" data-elementor-id="334" class="elementor elementor-334"
        ...
        <div class="elementor-inner">
            <div class="elementor-section-wrap">
                <section
                        class="elementor-section elementor-top-section elementor-element elementor-element-20adf605 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                        data-id="20adf605" data-element_type="section">
                    <div class="elementor-container elementor-column-gap-default">
                        <div class="elementor-row">
                            <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-7059da6c"
                                 data-id="7059da6c" data-element_type="column">
                                <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
                                        <div class="elementor-element elementor-element-21261d25 elementor-widget elementor-widget-shortcode"
                                             data-id="21261d25" data-element_type="widget"
                                             data-widget_type="shortcode.default">
                                            <div class="elementor-widget-container">
                                                <div class="elementor-shortcode">
                                                    <div id="register-form" class="widecolumn ova_register_user"><h3
                                                            class="title">Register User</h3>
                                                        <form id="signupform"
                                                              action="<?php echo $_SERVER['PHP_SELF'];?>"
                                                              method="post"><p class="form-row ova-email-icon"><input
                                                                placeholder="Email *"  required type="text" name="email"
                                                                id="email" class="required"
                                                                data-msg="Please insert email"></p>
                                                            <p class="form-row ova-user-icon"><input
                                                                        placeholder="Password *"required  type="password" name="password"
                                                                        id="password" class="required"
                                                                        data-msg="Please insert Password"></p>
                                                            <p class="form-row ova-user-icon"><input
                                                                    placeholder="Username *" required type="text" name="username"
                                                                    id="username" class="required"
                                                                    data-msg="Please insert Username"></p>
                                                            <p class="form-row ova-user-icon"><input
                                                                    placeholder="First name *" type="text"
                                                                    name="nome" id="nome" required class="required"
                                                                    data-msg="Please insert First name"></p>
                                                            <p class="form-row ova-user-icon"><input
                                                                    placeholder="Last name *"  required type="text" name="cognome"
                                                                    id="last-name" class="required"
                                                                    data-msg="Please insert Last name"></p>
                                                            <p class="form-row ova-phone-icon"><input
                                                                    placeholder="Phone" type="text" name="telefono"
                                                                    id="user_phone" class=""
                                                                    data-msg="Please insert Phone" pattern="{10} [0-9]"></p>

                                                            <p class="form-row ova-address-icon"><input
                                                                    placeholder="Address" type="text"
                                                                    name="indirizzo" id="user_address" class=""
                                                                    data-msg="Please insert Address"></p>


                                                            <p class="form-row el-register-dcma"><input type="checkbox" required
                                                                                                        name="el_dcma"
                                                                                                        value="dcma"
                                                                                                        class="register_term  required "
                                                                                                        data-msg="Please check terms and conditions">
                                                                <span class="terms-and-conditions-checkbox-text"> I have read and agree to the website <a
                                                                        href="./TermAndCondition.php"
                                                                        class="terms-and-conditions-link"
                                                                        target="_blank"> terms and conditions </a> </span>
                                                            </p>
                                                            <p class="signup-submit"><input type="submit" name="invia"
                                                                                            class="ova-btn ova-btn-main-color"
                                            ...
                                            <div class="elementor-element elementor-element-73e6158 elementor-widget elementor-widget-image"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-image"><a
                                                            href="https://ovatheme.com/meup/member-register/#"> <img
                                                            src="./styles/Register/Asset-9.svg"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="ova-contact">
                                                        ...
                                                        <div class="address"><span><a
                                                                href="https://ovatheme.com/meup/member-register/#">San Francisco City Hall, San Francisco, CA</a></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="elementor-column-wrap elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            ...
                                            <div class="elementor-element elementor-element-43a8fc4 elementor-widget elementor-widget-image"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-image"><img
                                                            src="./styles/Register/apple-store-1-p5xxuvodl3i0xyrf15wbtg5ymuz4eoyk5w9tye8x6o.png"
                                            ...
                                            <div class="elementor-element elementor-element-059c2f8 elementor-widget elementor-widget-image"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-image"><img
                                                            src="./styles/Register/google_play-1-p5xxuvodl3i0xyrf15wbtg5ymuz4eoyk5w9tye8x6o.png"
...
<link rel="stylesheet" id="google-fonts-2-css" href="./styles/Register/css(2)" type="text/css" media="all">


<a id="scrollUp" href="https://ovatheme.com/meup/member-register/#top"
   title="&lt;i class=&quot;fas fa-angle-up&quot;&gt;&lt;/i&gt;"
   style="display: none; position: fixed; z-index: 998;"><i class="fas fa-angle-up"></i></a></body> <?php
if(isset($_POST['invia'])){
    ...
    $res = sing_in($connection, $nome, $cognome, $email, $password, $telefono, $indirizzo, $username);
