...
?>
<html lang="en">
<head><style type="text/css">.swal-icon--error{border-color:#f27474; 
...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center" style="background-color : #182150"> <!-- dfedf0 -->
...
$result=select_ordine($connect, $id);
$result = mysqli_fetch_array($result);
    $codice=$result["codice_ticket"];
$codiceE=$result["codice_evento"];
$nomeE=$result["nome_evento"];
...
$biglietti=$result["biglietti"];
$biglietti_vip=$result["biglietti_vip"];
$costo=$result["costo"];
$costoB=$result["costoB"];
$costoB*=$biglietti;
$costoBS=$result["costoBS"];
$costoBS*=$biglietti_vip;
$spedizione=$result["spedizione"];

$costoSub=$costoB+$costoBS;
                        ...
                        <div class='card px-2'>
                            <div class='card-body'>
                                <div class='container-fluid'>
                                    <h3 class='ext-right my-5'>MeUp</h3>
                                    <h3 class='mt-5 mb-2 text-right'><b>Codice ticket:&nbsp;&nbsp;$codice</b></p>

                                    <hr>
                                </div>
                                <div class='container-fluid d-flex justify-content-between'>
                                    <div class='col-lg-3 pl-0'>
                                        <p class='mt-5 mb-20'><b>Indirizzo di spedizione</b></p>
                                        <p>$cap<br>$stato,<br>$citta, $via.</p>
                                      
                                    </div>
                                    <div class='col-lg-3 pr-0'>
                                        <p class='mt-5 mb-2 text-right'><b>Spedito a</b></p>
                                        <p class='text-right'>$nome  $cognome </p>
                                        <p class='mt-5 mb-2 text-right'><b>Data evento</b></p>
                                        <p class='text-right'>$data, $orario[0]:$orario[1] </p>
                                    </div>
                                </div>";
                                    ...
                                    <div class="table-responsive w-100">
                                        <table class="table">
                                            ...
                                            <tr class="bg-dark text-white">
                                                ...
                                                <th>Codice Evento</th>
                                                <th>Nome</th>
                                                <th>Biglietti standard</th>
                                                <th>Biglietti vip</th>
                                                <th class="text-right">Costo biglietti standard</th>
                                                <th class="text-right">Costo biglietti vip</th>
...
<?php
    ...
    echo"
                                            <tr class='text-right'>
                                                <td class='text-left'>#$codiceE</td>
                                                <td class='text-left'>$nomeE</td>
                                            <td class='text-left'>$biglietti</td>
                                                <td class='text-left'>$biglietti_vip</td>
                                                <td>$$costoB</td>
                                                <td>$$costoBS</td>
                                                <td>$$costoSub</td>
                                            </tr>";
                    ...
                    echo"
                                ...
                                <p class='text-right'>Tax  : $5</p>";
                          if($spedizione=="si"){ echo"<p class='text-right'>Spedizione  : $5</p>";}
                          else{ echo"<p class='text-right'>Spedizione  : $0</p>";}

                                  echo"  <h4 class='text-right mb-5'>Total + iva + spedizione : $$costo</h4>";
                                                ?>
                                    <hr>
                                </div>
