                        ...
                        <div class='card px-2'>
                            <div class='card-body'>
                                <div class='container-fluid'>
                                    <h3 class='ext-right my-5'>Ticket evento: $nomeE</h3>
                                ...
                                <div class='container-fluid d-flex justify-content-between'>
                                 ...
                                 <div class='container-fluid d-flex justify-content-between'>
                                    <div class='col-lg-3 pl-0'>
                                        <p class='mt-5 mb-20'><b>Ticket Standard</b></p>
                                        <p>$biglietti</p>
                                      
                                    </div>
                                    <div class='col-lg-3 pl-0'>
                                        <p class='mt-5 mb-2 text-right'><b>Ticket Vip</b></p>
                                        <p class='text-right'>$biglietti_vip</p>
