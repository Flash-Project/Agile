<!DOCTYPE html>
<html lang="en">
<?php  include("../functions/connection.php"); include("../functions/event_pull.php"); $connect=connection(); session_start(); $a=$_SESSION["ruolo"]; ?>
                  ...
                  <div class="col-sm-12">
                      <div class="d-sm-flex justify-content-between align-items-center mb-4">
                          <div>
                              ...
                              <h4 class="font-weight-bold mb-0">EventPlanner's Sales</h4>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="card-body">
                      ...
                      <form method="POST" enctype="multipart/form-data" action="../functions/insert_sconto.php">
                          ...
                          <div class="form-group row">
                              <div class="col">
                                  <label>Nome</label>
                                  <input class="form-control" name="nome" style='border: 0.5px solid grey'>
                              </div>

                              <div class="col">
                                  <label>Percentuale</label>
                                  <input class="form-control" name="percentuale" style='border: 0.5px solid grey'>
                              </div>
                                          ...
                                          <div class="table-responsive">
                                              <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                  <div class="row"><div class="col-sm-12 col-md-6">
                                                          ...
                                                          <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info" style="text-align: center">
                                                              <thead>
                                                              <tr role="row">
                                                              ...
                                                              while($row = mysqli_fetch_array($result)){
                                                                 $idsconto=$row['id'];
                                                                  ...
                                                                  echo" <tr>  
                                                                        ...
                                                                        <td><a class='btn btn-outline-primary' href='../functions/sconto_delete.php?id=$idsconto' onclick='return conferma1()'>Delete</a></td>";
