<!DOCTYPE html>
<html lang="en">
<?php  include("../functions/connection.php"); $connect=connection(); session_start(); $a=$_SESSION["ruolo"];
              ...
              <div class="row">
                  <div class="col-sm-12">
                      <div class="d-sm-flex justify-content-between align-items-center mb-4">
                          <div>
                              <p class="text-small text-dark mb-1">Backend / Review</p>
                              <h4 class="font-weight-bold mb-0">Show Review</h4>
                          </div>
                      </div>
                  </div>
              </div>
                      ...
                      <div class="row"> <!----------------------------------------------------------------------------------- ------------------->
                          <div class="content-wrapper">
                              <div class="card" style='border: 0.5px solid grey;'>
                                  <div class="card-body">
                                      <h4 class="card-title">Recensioni Immesse</h4>
                                      <div class="row">
                                          <div class="col-12">
                                                      ...
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  ...
                                                                  <tr role="row">
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Nome evento</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased On: activate to sort column ascending" style="width: 185px;">Nome Cliente</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 139px;">email Cliente</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Ship to: activate to sort column ascending" style="width: 112px;">Stelle</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Base Price: activate to sort column ascending" style="width: 147px;">Descrizione</th>
                                                                      <?php if($a=='Proprietario'){ echo"<th class='sorting' tabindex='0' aria-controls='order-listing' rowspan='1'  aria-label='Actions: activate to sort column ascending' style='text-align:center;width: 118px;'>Actions</th>";} ?>
                                                           ...
                                                           <?php
                                                                    ...
                                                                    $result=select_recensioni($connect);
                                                                    ...
                                                                    while($row = mysqli_fetch_array($result)){
                                                                        ...
                                                                        $nome=$row['nome'];
                                                                        $email=$row['email'];
                                                                        $nomeEvento=$row['evento'];
                                                                        $valutazione=$row['rating'];
                                                                        $dettaglio=$row['descrizione'];
                                                                        ...
                                                                        <td>$valutazione</td>
                                                                        <td>$dettaglio</td>";
                                                                       if($a=='Proprietario'){ echo" <td><a class='btn btn-outline-primary' href='../functions/review_delete.php?id=$id' onclick='return conferma1()'>Delete</a></td>";}
