    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          <div class="content-wrapper">
                  ...
                  <div class="col-sm-12">
                      <div class="d-sm-flex justify-content-between align-items-center mb-4">
                          <div>
                              ...
                              <h4 class="font-weight-bold mb-0">Insert Info</h4>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="card">
                  <div class="card-body">
                      <h4 class="card-title">Info for EventPlanner's event</h4>
                      ...
                      <!--<form class="forms-sample">-->&emsp;&emsp;&emsp;&emsp;

                          <div class="form-group row">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                              <table style="align-content: center">
                                  <tr><td><label>Categoria</label></td><td><label>Svg (deve avere lo stesso nome della categoria, solo formato png)</label></td></tr>
                                  <tr>
                                      <td><input class="form-control" name="categoria" style='border: 0.5px solid grey; width: 250px;height: 35px'></td>&emsp;

                                      <td><input type="file" class="form-control" style='border: 0.5px solid grey; width: 250px;height: 35px' name="svg"></td></tr>

                                  <tr><td><label><br></br>Tipologia</label></td></tr><tr><td><input class="form-control" style='border: 0.5px solid grey; width: 250px;height: 35px' name="tipologia"></td></tr>
                          ...
                          <center><button type="sumbit" class="btn btn-danger btn-icon-text btn-lg" name="registra">
...
<center>
                      <div class="row" style="text-align: center;"> <!-----------------------------------------------------------------------------------                    ------------------->
                          &emsp;&emsp;&emsp;&emsp;  &emsp;&emsp;&emsp;
                              <div class="card" style="max-width: 440px;border: 0.5px solid grey">



                          <div class="card" style="max-width: 440px;border: 0.5px solid grey">
                              <div class="card-body">
                                  <h4 class="card-title">Generi Registrate</h4>
                                  <div class="row">
                                      <div class="col-12">
                                                  ...
                                                  <div class="row"><div class="col-sm-12 col-md-6">
                                                          ...
                                                          <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                              ...
                                                              <tr role="row">
                                                                  ...
                                                                  <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased On: activate to sort column ascending" style="width: 185px;">Categorie</th><th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="3" aria-label="Actions: activate to sort column ascending" style="text-align:center;width: 118px;">Actions</th>
                                                              ...
                                                              while($row = mysqli_fetch_array($result)){
                                                                  ...
                                                                  echo" <tr>  
                                                                        ...
                                                                        <td><a class='btn btn-outline-primary' href='../functions/categoria_delete.php?id=$cod' onclick='return elimina()'>Delete</a></td>
                          ...
                          <div class="row">&emsp;&emsp;&emsp;
                                  <div class="card" style="max-width: 440px;border: 1px solid black">
                                      <div class="card-body">
                                          <h4 class="card-title">Tipologie registrate</h4>
                                          <div class="row">
                                              <div class="col-12">
                                                  <div class="table-responsive">
                                                      <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                          <div class="row"><div class="col-sm-12 col-md-6">
                                                                  ...
                                                                  <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                      ...
                                                                      <tr role="row">
                                                                          <th class="sorting_asc" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Order #: activate to sort column descending" style="width: 115px;">Codice</th>
                                                                          <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased On: activate to sort column ascending" style="width: 185px;">Tipologia</th><th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="3" aria-label="Actions: activate to sort column ascending" style="text-align:center;width: 118px;">Actions</th>
                                                                      ...
                                                                      while($row = mysqli_fetch_array($result)){
                                                                        ...
                                                                        <td>$cont</td> 
                                                                        <td>$nome</td>
                                                                        <td><a class='btn btn-outline-primary' href='../functions/tipologia_delete.php?id=$cod' onclick='return elimina()'>Delete</a></td>
...
$categoria=$_POST["categoria"];
    ...
    if($categoria){
        ...
        $err=0;
    if(isset($_FILES["svg"])) {
        if ((($_FILES["svg"]["type"] == "image/gif")
                || ($_FILES["svg"]["type"] == "image/jpeg")
                || ($_FILES["svg"]["type"] == "image/pjpeg")
                || ($_FILES["svg"]["type"] == "image/png"))
            && ($_FILES["svg"]["size"] < 40000000))
        {
            move_uploaded_file($_FILES["svg"]["tmp_name"],
                "upload/" . $_FILES["svg"]["name"]);
            $svg=$_FILES["svg"]["name"];}
        else
        {
            $err=1;
    ...
    insert_categoria($connect,$categoria);}


    if($tipologia)
        insert_tipologia($connect,$tipologia);
    //header("location: ./info-event.php");
}
