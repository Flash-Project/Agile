<!DOCTYPE html>
<html lang="en">
<?php  include("../functions/connection.php"); $connection=connection(); session_start(); $a=$_SESSION["ruolo"]; 
            ?>
                      ...
                      <div class="row"> <!----------------------------------------------------------------------------------- ------------------->
                          <div class="content-wrapper">
                              <div class="card" style='border: 0.5px solid grey;'>
                                  <div class="card-body">
                                      <h4 class="card-title">Email ricevute</h4>
                                      <div class="row">
                                          <div class="col-12">
                                                      ...
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  ...
                                                                  <tr role="row">
                                                                    ...
                                                                    <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Nome</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Email</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Messaggio</th>
                                                           ...
                                                           <?php
                                                                    ...
                                                                    $cont=1;
                                                                    $query="SELECT * FROM email_ricevute";
                                 ...
                                 ";
                                                                       if($a=='Proprietario'){ echo" <td><a class='btn btn-outline-primary' href='../functions/emailricevute_delete.php?id=$cod' onclick='return conferma1()'>Delete</a></td>";}
