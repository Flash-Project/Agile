              ...
              <div class="row">
                  <div class="col-sm-12">
                      <div class="d-sm-flex justify-content-between align-items-center mb-4">
                          <div>
                                  <p class="text-small text-dark mb-1">Backend / Events</p>
                              <h4 class="font-weight-bold mb-0">Show Event</h4>
                          </div>
                      </div>
                  </div>
              </div>
                      ...
                      <div class="row"> <!----------------------------------------------------------------------------------- ------------------->
                          <div class="content-wrapper">
                              <div class="card" style='border: 0.5px solid grey;'>
                                  <div class="card-body">
                                      <h4 class="card-title">Eventi Inseriti</h4>
                                      <div class="row">
                                          <div class="col-12">
                                                      ...
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  ...
                                                                  <tr role="row">
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Genere</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Tipologia</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Biglietti</th>
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1"  aria-label="Actions: activate to sort column ascending" style="text-align:center;width: 118px;">Actions</th><th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1"  aria-label="Actions: activate to sort column ascending" style="text-align:center;width: 118px;">Actions</th>
                                                                  ...
                                                                  <?php
                                                                    ...
                                                                    $result=select_evento_backend($connect);
                                                                    while($row = mysqli_fetch_array($result)){
                                                                        ...
                                                                        //pending se sta per esaurirsi
                                                                        // <label class="badge badge-success">Closed</label> se sta in stock
                                                                        echo" <tr>  
                                                                        <td>$codice</td> 
                                                                        <td>$nome</td>
                                                                        <td>$categoria</td>
                                                                        ...
                                                                        <td><a class='btn btn-outline-primary' href='../Details.php?id=$idevento' target='_blank'>View</a></td>
                                                                        <td><a class='btn btn-outline-primary' href='./edit-event.php?id=$idevento'>Edit</a></td>
                                                                        <td><a class='btn btn-outline-primary' href='../functions/event_delete.php?id=$idevento' onclick='return elimina()'>Delete</a></td>
                                                                        </tr> ";} 
                         ?>
                                                                  </tbody>
                                                              </table>
