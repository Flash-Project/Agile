        ...
        <form class="row"  method='POST' enctype='multipart/form-data' action="<?php echo $_SERVER['PHP_SELF']; ?>">
          <div class="col-lg-8">
            <ul class="custom-nav nav nav-pills mb-5">
              ...
              <li class="nav-item w-25"><a class="nav-link text-sm <?php if(empty($_COOKIE['idconsegna'])){ echo'disabled';} ?>" href="checkout4.php">Checkout Confirmed</a></li>
            </ul>
            ...
            <div class="row">
                ...
                <div class="card-radio mb-4">
                  ...
                  <div class="card">   
                    <div class="card-header">
                      <h6 class="mb-0">Biglietto Online</h6>
                    </div>
                    <div class="card-body">
                      <p class="text-muted text-sm">Scarica subito il tuo biglietto senza costi aggiuntivi</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="card-radio mb-4">
                  ...
                  <div class="card">   
                    <div class="card-header">
                      <h6 class="mb-0">Spedizione Ticket</h6>
                    </div>
                    <div class="card-body">
                      <p class="text-muted text-sm">Spedizione standard del biglietto, dai 5-10 giorni di attesa, costo aggiuntivo di $5 </p>
                    </div>
                  </div>
                </div>
              </div>
